...
export function buildComparisonCards(co2Tons: number): ComparisonCardData[] {
  ...
  return [
    card({
      ...
      unit: "km",
      description: "Like driving an average gasoline-powered car X kilometers.",
    ...
    card({
      ...
      unit: "return flights",
      description: "Equivalent to X passenger return flights between Amsterdam and New York.",
    ...
    card({
      ...
      description: "Like travelling around Earth X times by modern passenger train.",
    ...
    card({
      ...
      unit: "liters",
      description: "Equivalent to burning X liters of gasoline.",
    ...
    card({
      ...
      unit: "households",
      description: "Enough to match the annual electricity use of X average households.",
    ...
    card({
      ...
      unit: "showers",
      description: "Equivalent to the estimated emissions from X hot showers.",
    ...
    card({
      ...
      unit: "households",
      description: "Equivalent to the annual carbon footprint of X average households.",
    ...
    card({
      ...
      category: "Nature",
      icon: "🌳",
      title: "Forest area as football fields",
      value: calculateForestFields(co2Tons),
      unit: "football fields",
      description: "A forest covering X football fields absorbing CO₂ over one year at the assumed average rate.",
    ...
    card({
      ...
      unit: "km2",
      description: "A forested area of X square kilometers absorbing CO₂ over one year at the assumed average rate.",
    ...
    card({
      ...
      unit: "hamburgers",
      description: "Equivalent to the estimated production emissions of X hamburgers.",
    ...
    card({
      ...
      unit: "cups",
      description: "Equivalent to the estimated production emissions of X cups of coffee.",
    ...
    card({
      ...
      unit: "smartphones",
      description: "Equivalent to the estimated manufacturing emissions of X smartphones.",
    ...
    card({
      ...
      unit: "T-shirts",
      description: "Equivalent to the estimated production emissions of X cotton T-shirts.",
